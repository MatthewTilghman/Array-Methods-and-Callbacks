...
function getWinnersByYear(winnersCB, yearsCB) {
        return winnersCB.map((country, year) => `In ${yearsCB[year]}, ${country} won the world cup!`)
}
console.log(getWinnersByYear(getWinners(getFinals(fifaData)), getYears(getFinals(fifaData)))); //TODO Console log is correct
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 6: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
